...
|------------|-------------|
| **create-agents-md** | Generate hierarchical AGENTS.md structures for codebases. Creates organized, token-efficient documentation with root files and sub-folder specific instructions following JIT indexing and nearest-wins hierarchy principles. |
...
## Quick Start
- Copy or import the skill into the agent project and follow the instructions in the skill's folder.
